...
//
// Solidity: function adminWithdraw(address to, uint256 amount) returns()
func (_MyToken *MyTokenTransactor) AdminWithdraw(opts *bind.TransactOpts, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _MyToken.contract.Transact(opts, "adminWithdraw", to, amount)
}

// AdminWithdraw is a paid mutator transaction binding the contract method 0x401d4482.
//
// Solidity: function adminWithdraw(address to, uint256 amount) returns()
func (_MyToken *MyTokenSession) AdminWithdraw(to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _MyToken.Contract.AdminWithdraw(&_MyToken.TransactOpts, to, amount)
}

// AdminWithdraw is a paid mutator transaction binding the contract method 0x401d4482.
//
// Solidity: function adminWithdraw(address to, uint256 amount) returns()
func (_MyToken *MyTokenTransactorSession) AdminWithdraw(to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _MyToken.Contract.AdminWithdraw(&_MyToken.TransactOpts, to, amount)
}
...
// DepositToContract is a paid mutator transaction binding the contract method 0x7b30aa47.
//
// Solidity: function depositToContract(uint256 amount) returns()
func (_MyToken *MyTokenTransactor) DepositToContract(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _MyToken.contract.Transact(opts, "depositToContract", amount)
}

// DepositToContract is a paid mutator transaction binding the contract method 0x7b30aa47.
//
// Solidity: function depositToContract(uint256 amount) returns()
func (_MyToken *MyTokenSession) DepositToContract(amount *big.Int) (*types.Transaction, error) {
	return _MyToken.Contract.DepositToContract(&_MyToken.TransactOpts, amount)
}

// DepositToContract is a paid mutator transaction binding the contract method 0x7b30aa47.
//
// Solidity: function depositToContract(uint256 amount) returns()
func (_MyToken *MyTokenTransactorSession) DepositToContract(amount *big.Int) (*types.Transaction, error) {
	return _MyToken.Contract.DepositToContract(&_MyToken.TransactOpts, amount)
}
